...
$NANOPOLISH index -d $RAWDATA $BASECALLS  # indexes input files for methylation calling after alignment, later calls to nanopolish need to be started from this folder
